      ...
      sidebar={
        <div className="flex flex-col gap-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            <NumberField label="Grade g1" value={g1Percent} step={0.1} min={-15} max={15} onChange={setG1} unit="%" />
            <NumberField label="Grade g2" value={g2Percent} step={0.1} min={-15} max={15} onChange={setG2} unit="%" />
          </div>
          <ToggleGroup
          ...
          />
          {lengthMode === "manual" && (
            <NumberField label="Curve Length L" value={manualLengthFt} step={10} onChange={setManualLengthFt} unit="ft" />
          )}
          {curveClass === "sag" && (
    ...
    >
      <div className="grid h-full grid-cols-[300px_1fr] gap-3">
        ...
        <Panel title="Vertical Curve Coordinate Canvas" className="min-h-0 flex-1">
          <div className="h-full w-full rounded-sm border border-border-hairline engineering-grid">
            <VerticalCurveCanvas
              results={results}
